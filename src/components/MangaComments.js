      ...
      <div className="w-[1269px] bg-[#2D2D2D]">
        <div className="flex justify-around mt-12 ml-12 mr-12">
          ...
          <input
            ...
            className="w-[937px] h-[52px] rounded-[32px] bg-[#4B4B4B] text-2xl font-semibold pl-3 text-[#fff] outline-none"
          />
          <img
                ...
                <div className="flex flex-col">
                  <div className="w-[843px] bg-[#4B4B4B] text-white">
                    <div className="mx-12 my-6">
                      <h2 className="block mb-[10px] text-2xl font-semibold text-white">
                        User Name
                      </h2>
